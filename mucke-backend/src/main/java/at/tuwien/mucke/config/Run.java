 ...
 * multiple configurations. Configurations of runs are named in the 'system.properties' file via the property "run.properties". This
 * property points to a list of files. These files must exist in the same directory as the 'system.properties' file. The Run class for each
