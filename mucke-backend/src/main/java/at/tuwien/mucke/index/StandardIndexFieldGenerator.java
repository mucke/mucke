 ...
 * @author Ralf Bierig
 */
public class StandardIndexFieldGenerator extends IndexFieldGenerator {

    static Logger logger = Logger.getLogger(StandardIndexFieldGenerator.class);


    /**
     * Constructor. Defines the field this IndexFieldGenerator produces.
     */
    public StandardIndexFieldGenerator(String fieldname, String signature) {
