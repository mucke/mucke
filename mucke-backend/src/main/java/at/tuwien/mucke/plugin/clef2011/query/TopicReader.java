package at.tuwien.mucke.plugin.clef2011.query;

import at.tuwien.mucke.plugin.clef2011.ConfigConstants;
...
public class TopicReader {
     ...
     */
    private List<CLEF2011Query> topics = new ArrayList<CLEF2011Query>();
     ...
     */
    private CLEF2011Query readTopic(String xml) {

        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        DocumentBuilder builder = null;
        Document document = null;
        NodeList nodeList = null;
        CLEF2011Query topic = new CLEF2011Query();
     ...
     * @return the topics
     */
    public final List<CLEF2011Query> getTopics() {
        return topics;
    }
